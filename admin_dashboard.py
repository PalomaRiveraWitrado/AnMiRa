...
# Importamos la función que acabamos de validar y dejar al 100%
...
# =====================================================================
# ÁREA DE PRUEBAS LOCALES (Simulador de la App Principal)
# =====================================================================
if __name__ == "__main__":
    # Simulamos que la app está corriendo y que entramos como Admin a la sucursal 1 (Arcoiris)
    st.set_page_config(page_title="Test Dashboard Admin", layout="wide")
    st.title("🧪 Entorno de Pruebas Aislado (Admin)")
    
    # Selector de prueba para emular el comportamiento de las sucursales
    st.sidebar.header("⚙️ Simulador de Sesión")
    sucursal_simulada = st.sidebar.selectbox(
        "Selecciona Sucursal a Consultar:",
        options=[(1, "Arcoiris"), (2, "4 Caminos"), (3, "Triana"), (4, "Rosita"), (5, "Viñedos")],
        format_func=lambda x: x[1]
    )
    
    # Disparamos la función con los datos del simulador
    renderizar_tablero_combos_admin(sucursal_simulada[0], sucursal_simulada[1])